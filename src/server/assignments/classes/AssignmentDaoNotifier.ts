import {
  IAssignmentDaoNotifier,
  IAssignmentMultiNotifierOptions,
} from "../interfaces/IAssignmentDaoNotifier";
import {
  IAssignmentNotifier,
...
export class AssignmentDaoNotifier implements IAssignmentDaoNotifier {
  ...
  public async notifyParticipantsOfAssignment(
    options: IAssignmentMultiNotifierOptions,
  ): Promise<void> {
  ...
  public async notifyApplicantsOfAssignment(
    options: IAssignmentMultiNotifierOptions,
  ): Promise<void> {
